...
class Migration(migrations.Migration):
    ...
    replaces = [('dkron', '0001_initial_20210326'), ('dkron', '0004_remove_job_retries'), ('dkron', '0001_initial_v2'), ('dkron', '0001_initial'), ('dkron', '0002_auto_20190103_1758'), ('dkron', '0003_auto_20190110_1550'), ('dkron', '0004_auto_20190110_1804'), ('dkron', '0005_auto_20190213_1700'), ('dkron', '0006_job_retries'), ('dkron', '0001_squashed_0006_job_retries'), ('dkron', '0003_create_notify_event'), ('dkron', '0005_auto_20201104_0945'), ('dkron', '0002_job_notify_on_error')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule', models.CharField(help_text='https://dkron.io/usage/cron-spec/ or "@parent JOBNAME" for dependent jobs', max_length=255)),
